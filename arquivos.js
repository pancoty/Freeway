...
function preload(){//CARREGA OS ARQUIVOS
  ...
  A = loadImage("images/ator-1.png");//CARREGA A IMAGEM DO ATOR
  C1 = loadImage("images/carro-1.png");//CARREGA A IMAGEM DO CARRO 1
  C2 = loadImage("images/carro-3.png");//CARREGA A IMAGEM DO CARRO 2
  C3 = loadImage("images/carro-2.png");//CARREGA A IMAGEM DO CARRO 3
